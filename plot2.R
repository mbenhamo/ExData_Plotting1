...
## Create a plot of the Global Active Power against time:
with(dat,plot(Global_active_power~as.POSIXct(Time),xlab="",ylab="Global Active Power (kilowatts)",main="",type="l"))
